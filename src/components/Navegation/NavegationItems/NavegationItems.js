...
const NavegationItems = (props)=>{
    return(
        ...
        <NavegationItem destination='/' fontSize='20px'>Account</NavegationItem>
        <NavegationItem destination='/'  fontSize='20px'>Log Out <VscArrowRight style={{ verticalAlign: "middle" }}/> </NavegationItem>
        </ul>
    )
}
